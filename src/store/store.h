...
/* Get distinct file paths for a project filtered by node label (e.g. "Class", "Module").
 * Caller must free each out[i] and out itself. Returns CBM_STORE_OK or CBM_STORE_ERR. */
